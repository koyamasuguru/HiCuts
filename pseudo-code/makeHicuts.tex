...
\SetKwProg{Fn}{Function}{}{end}\SetKwFunction{make}{makeDecisionTree}
\SetKwProg{Fn}{Function}{}{end}\SetKwFunction{get}{getNumberOfRule}
...
\SetKwFunction{makeDecisionTree}{makeDecisionTree}%
\SetKwProg{CUT}{Function}{}{end}\SetKwFunction{make}{makeDecisionTree}
\begin{algorithm}
\CUT(\tcc*[h]{binthとルール数の比較}){\makeDecisionTree{$n$}}{
\KwData{ノード}
\KwResult{なし}
\tcc{this is a comment to tell you that we will now really start code}
\If{this is true}{$n$.ch $\leq$ $binth$\;
return;
}
...
\SetKwFunction{getNumberOfRule}{getNumberOfRule}%
\SetKwProg{CUT}{Function}{}{end}\SetKwFunction{get}{getNumberOfRule}
\begin{algorithm}
\CUT(\tcc*[h]{binthと比較するための，任意のノードにあるルール数を求める}){\getNumberOfRule{}}{
\KwData{}
\KwResult{ルール数}
\tcc{this is a comment to tell you that we will now really start code}
% \If(\tcc*[h]{a simple if but with a comment on the same line}){this is true}
